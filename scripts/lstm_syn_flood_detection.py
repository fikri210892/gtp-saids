...
if unique_classes < 2:
    print("⚠️  WARNING: Only one class in test data!")
...
print("✅ Model saved: outputs/lstm_syn_flood_model.h5")
...
print("✅ Saved: outputs/lstm_predictions.png")
plt.close()
...
print("="*70)
print("\nGenerated files:")
print("  📊 lstm_training_history.png     - Training metrics")
print("  🔥 lstm_confusion_matrix.png     - Confusion matrix heatmap")
print("  📈 lstm_predictions.png          - Predictions vs actual")
print("  🤖 lstm_syn_flood_model.h5       - Trained model")
print("\n✅ Done!")
